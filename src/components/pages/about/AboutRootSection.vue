<template>
  <section>
    <section>
      ...
      <p>
        Le recours au numérique a également autorisé une actualisation partielle des données : si le texte en ligne reste celui des dictionnaires imprimés, hormis des corrections limitées, chaque lieu a été localisé par rapport à la géographie administrative de 2011 – date retenue car antérieure au redécoupage cantonal
        de 2014 et à la multiplication des fusions de communes observée ces dernières années. Un lien vers le <a href="https://www.insee.fr/fr/information/2016807" target="_blank">code officiel géographique de l’INSEE</a> offre par ailleurs la possibilité de situer chaque commune dans la hiérarchie administrative
        actuelle.
      </p>
      <p>
      ...
      <p>
        ...
        de recherche seront à terme implémentées, notamment des tris et filtres par date et par type de lieu. L’équipe du projet travaille enfin à l’amélioration de la géolocalisation à l’échelle infra-communale.
      </p>
    </section>
  </section>
</template>
