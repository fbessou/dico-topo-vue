<template>
  <article>
    ...
    <p>Ressources :</p>
    <ul>
      <li>Fonds de cartes : <a href="https://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> et <a href="https://www.geoportail.gouv.fr/" target="_blank">Géoportail (IGN)</a> pour la carte de Cassini</li>
      <li>Images des pages des dictionnaires topographiques : <a href="https://gallica.bnf.fr/" target="_blank">Gallica (BnF)</a></li>
    </ul>
    <p>Hébergement : <a href="https://www.huma-num.fr/" target="_blank">TGIR Huma-Num</a></p>
    <p>Le développement de l’application a été financé par l’<a href="http://www.chartes.psl.eu/" target="_blank">École nationale des chartes</a>.</p>
    <p>Le travail de numérisation et de restructuration XML des volumes des dictionnaires topographiques consultables grâce à l’application est au cœur du projet scientifique depuis 2010. Ce chantier colossal a été soutenu par le <a href="https://francearchives.fr/fr/" target="_blank">Service interministériel des Archives de France</a>, le <a href="http://cths.fr/" target="_blank">Comité des travaux historiques et scientifiques</a>, les <a href="http://www.archives-nationales.culture.gouv.fr/" target="_blank">Archives nationales</a> et des services d’archives départementales.</p>
    ...
    <p>L'utilisation, le partage et l’adaptation du contenu sont autorisés selon les termes de la licence <a href="https://creativecommons.org/licenses/by/3.0/fr/legalcode" target="_blank">Creative Commons Attribution 3.0 (cc-by)</a>.</p>
  </article>
</template>
